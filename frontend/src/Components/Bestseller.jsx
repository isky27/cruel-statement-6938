import { Image, Heading, Text, SimpleGrid, Box, Flex, Button } from "@chakra-ui/react";
...
const data = [
  {
    ...
    desc: "Absorbs oil,adds volume+balance the scalp for refreshed hair in between washes",
    price: "$39",
    rating: "5.0",
    comments: "11",
    tag: "NEW ARRIVAL",
  },
  {
    ...
    desc: "Energize millions of surface skin cells by 200% to address all key signs of skin aging",
    price: "$175",
    rating: "4.5",
    comments: "3639",
    tag: "BEST SELLER",
  },
  {
    ...
    desc: "Nightly conditioning serum gives the apprerance of longer, darker-looking skin lashes",
    price: "$155",
    rating: "4.6",
    comments: "8603",
    tag: "BEST SELLER",
  },
  {
    ...
    desc: "Visibly firm + improves all eye area wrinkles to restore youthful, natural contour",
    price: "$70",
    rating: "4.6",
    comments: "10283",
    tag: "NEW ARRIVAL",
  },
  {
    ...
    desc: "Multi-targeted skincare treatment that instantly and visibly firms, tightens + smooths.",
    price: "$105",
    rating: "3.2",
    comments: "674",
    tag: "NEW ARRIVAL",
  ...
  },
  {
    ...
    desc: "Wake up to vibrant skin! This supercharged serum empowers skin’s own renewing process.",
    price: "$102",
    rating: "4.8",
    comments: "4221",
    tag: "BEST ARRIVAL",
